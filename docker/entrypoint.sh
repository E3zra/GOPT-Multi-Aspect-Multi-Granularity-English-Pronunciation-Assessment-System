...
if [ -d "/workspace/models/librispeech" ]; then
    echo "[1/4] Setting up LibriSpeech model links..."
    ...
    echo "[1/4] ⚠ LibriSpeech models not found at /workspace/models/librispeech/"
...
echo "[2/4] Checking GOPT pretrained model..."
